...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen text-slate-100 antialiased">
      <canvas
        ref={canvasRef}
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section id="knowledge" className="scroll-mt-20 py-12">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <a href="/knowledge/ai" className="holo-card group block rounded-2xl border border-cyan-500/20 bg-black/20 p-6 backdrop-blur-xl transition hover:border-cyan-400/30">
              ...
              <p className="mt-2 text-sm text-slate-400">
                视频转文本辅助学习、RAG 技术应用等实践总结与最佳实践。
              </p>
              <span className="mt-4 inline-block text-xs font-medium text-cyan-400/90">进入详情 →</span>
            </a>
            <a href="/knowledge/insights" className="holo-card group block rounded-2xl border border-cyan-500/20 bg-black/20 p-6 backdrop-blur-xl transition hover:border-cyan-400/30">
              <h3 className="text-lg font-semibold text-slate-50 group-hover:text-cyan-300" style={{ fontFamily: '"Geist", "SF Pro Text", system-ui, sans-serif' }}>
                行业洞察与技术雷达
              </h3>
              <p className="mt-2 text-sm text-slate-400">
                追踪前沿模型演进与 Agent 架构最佳实践，输出深度商业分析与技术研判。
              </p>
              <span className="mt-4 inline-block text-xs font-medium text-cyan-400/90">进入详情 →</span>
            </a>
          </div>
